...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/memberlist">
  ...
  <div class="form-group">
    <div class="col-sm-2">
	<input type="text" name="sdate" id="sdate"  class="form-control" placeholder="出生日期"/>
...
<table class="table table-hover table-striped table-bordered">
 <tr><th>学生列表 &nbsp; &nbsp;
 <!--
 <button type="button" onclick="location.href='<%=path %>/memberadd'" class="btn  btn-primary">添加</button>
 -->
</th></tr></table>
<table class="table table-hover table-striped table-bordered">
 <thead>
...
<td> 
 <a href="<%=path %>/memberedit?id=${c.id}&forword=memberlist" class="btn btn-default">修改</a> |
 <a href="memberdel?id=${c.id}&forword=memberlist" onClick="return confirm('您确定要删除吗?')" class="btn btn-default">删除</a>
 </td>
</tr></tbody>
</c:forEach> </table><script type="text/javascript">
	       function go(index)
           {
               window.location.href="<%=path %>/memberlist?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
