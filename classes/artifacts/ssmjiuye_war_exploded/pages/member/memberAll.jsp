...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/memberAll">
...
<td>${c.email}</td>
<!--<td>  <a href="<%=path %>/resumeAll?member=${c.id }" class="btn btn-info">查看他的简历</a> -->
</td>
</tr></tbody>
</c:forEach> </table><script type="text/javascript">
	       function go(index)
           {
               window.location.href="<%=path %>/memberAll?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
  ...
  </table></html><jsp:include page="../foot.jsp"></jsp:include>