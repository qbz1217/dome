...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/tousuAll">
...
<c:forEach items="${business}" var="s"  varStatus="ss">
...
<td>${c.zt}</td>
	       ...
	       function go(index)
           {
               window.location.href="<%=path %>/tousuAll?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
