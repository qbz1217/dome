...
</script><form name="formAdd" method="post" action="<%=path %>/jiaoshiinsert" class="form-horizontal" role="form">
...
<div class="form-group">
             <label class="col-sm-2 control-label" for="xueyuan">学院</label>
              <div class="col-sm-4">
<input name="xueyuan" type="text" id="xueyuan" value="" placeholder="学院" class="form-control" >
...
<div class="form-group">
             <label class="col-sm-2 control-label" for="tel">电话</label>
              <div class="col-sm-4">
<input name="tel" type="text" id="tel" value="" placeholder="电话" class="form-control" >
...
<div class="form-group">
             <label class="col-sm-2 control-label" for="username">账号</label>
              <div class="col-sm-4">
<input name="username" type="text" id="username" value="" placeholder="账号" class="form-control" >
     ...
     <legend></legend>
		<div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
			       <input name="forword" type="hidden" value="jiaoshilist"/>
