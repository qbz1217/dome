...
</script><form name="formAdd" method="post" action="<%=path %>/positioninsert" class="form-horizontal" role="form">
	<fieldset> <legend>添加招聘职位</legend>	

<div class="form-group">
             <label class="col-sm-2 control-label" for="name">职位名称</label>
              <div class="col-sm-4">
<input name="name" type="text" id="name" value="" placeholder="职位名称" class="form-control" >
...
<div class="form-group">
             <label class="col-sm-2 control-label" for="didian">工作地点</label>
              <div class="col-sm-4">
<input name="didian" type="text" id="didian" value="" placeholder="工作地点" class="form-control" >
...
<div class="form-group">
   <label class="col-sm-2 control-label" for="renshu">招聘人数</label>
    <div class="col-sm-4">
<input name="renshu" type="text" id="renshu" value=""  class="form-control"  onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" >
</div>
	</div>
...
<div class="form-group">
             <label class="col-sm-2 control-label" for="xyaoqiu">学历要求</label>
              <div class="col-sm-4">
<input name="xyaoqiu" type="text" id="xyaoqiu" value="" placeholder="学历要求" class="form-control" >
...
<div class="form-group">
             <label class="col-sm-2 control-label" for="price">岗位工资</label>
              <div class="col-sm-4">
<input name="price" type="text" id="price" value="" placeholder="岗位工资" class="form-control" >
 </div>
	</div>
...
<div class="form-group">
   <label class="col-sm-2 control-label" for="details">职位详情</label>
    <div class="col-sm-4">
<textarea name="details" id="details" style="width:500px;height:340px"></textarea>
...
<input name="business" type="hidden" value="${sessionScope.loginid}">
     ...
     <legend></legend>
		<div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
			       <input name="forword" type="hidden" value="positionmy"/>
