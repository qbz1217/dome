...
</script><form name="formAdd" method="post" action="noticeupdate" class="form-horizontal" role="form">
<fieldset> <legend>修改新闻公告</legend>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="title">标题</label>
      <div class="col-sm-4">
<input name="title" type="text" id="title"  value="${c.title}"  class="form-control" >
 </div>
	</div>
...
<div class="form-group">
   <label class="col-sm-2 control-label" for="neirong">内容</label>
    <div class="col-sm-4">
						      <textarea name="neirong" id="neirong" style="width:500px;height:340px">${c.neirong }</textarea>
	                            <script type="text/javascript">
