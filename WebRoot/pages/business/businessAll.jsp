...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/businessAll">
...
<td>${c.tel}</td>
<td><a href="<%=path %>/positionAll?business=${c.id }" class="btn btn-info">查看职位</a> </td>
<td><a href="<%=path %>/businessview?id=${c.id}" class="btn-default" >查看详情</a></td>
</tr></tbody>
</c:forEach> </table><script type="text/javascript">
	       function go(index)
           {
               window.location.href="<%=path %>/businessAll?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
