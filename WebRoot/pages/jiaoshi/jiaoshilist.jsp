...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/jiaoshilist">
...
<table class="table table-hover table-striped table-bordered">
 <tr><th>教师列表 &nbsp; &nbsp;
 <!--
 <button type="button" onclick="location.href='<%=path %>/jiaoshiadd'" class="btn  btn-primary">添加</button>
 -->
</th></tr></table>
<table class="table table-hover table-striped table-bordered">
 <thead>
...
<td> 
 <a href="<%=path %>/jiaoshiedit?id=${c.id}&forword=jiaoshilist" class="btn btn-warning">修改</a> |
 <a href="jiaoshidel?id=${c.id}&forword=jiaoshilist" onClick="return confirm('您确定要操作吗?')" class="btn btn-default">删除</a>
 </td>
</tr></tbody>
</c:forEach> </table><script type="text/javascript">
	       function go(index)
           {
               window.location.href="<%=path %>/jiaoshilist?index="+index;
           }
</script>
