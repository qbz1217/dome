...
<table class="table table-hover table-striped table-bordered">
 <tr><th>管理员列表 &nbsp; &nbsp;
 <!--
 <button type="button" onclick="location.href='<%=path %>/adminadd'" class="btn  btn-primary">添加</button>
 -->
</th></tr></table>
<table class="table table-hover table-striped table-bordered">
 <thead>
...
<td> 
 <a href="<%=path %>/adminedit?id=${c.id}&forword=adminlist" class="btn btn-default">修改</a> |
 <a href="admindel?id=${c.id}&forword=adminlist" onClick="return confirm('您确定要删除吗?')" class="btn btn-default">删除</a>
 </td>
</tr></tbody>
</c:forEach> </table><script type="text/javascript">
	       function go(index)
           {
               window.location.href="<%=path %>/adminlist?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
