...
document.formAdd.submit();
    ...
    <form name="formAdd" method="post" action="<%=path %>/admininsert" class="form-horizontal" role="form">
	<fieldset>
        <legend>添加管理员</legend>
...
<div class="form-group">
             <label class="col-sm-2 control-label" for="adminname">管理员账号</label>
              <div class="col-sm-4">
<input name="adminname" type="text" id="adminname" value="" placeholder="管理员账号" class="form-control" >
 </div>
	</div>
<div class="form-group">
     ...
     <legend></legend>
		<div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
			       <input name="forword" type="hidden" value="adminlist"/>
